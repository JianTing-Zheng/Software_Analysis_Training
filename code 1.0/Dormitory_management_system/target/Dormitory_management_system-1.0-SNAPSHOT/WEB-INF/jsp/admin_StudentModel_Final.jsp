        ...
        success: function (data) {
          ...
          $.each(data, function (i, n) {
            $("#studentInfo").append("<tr>")
                ...
                .append('<td bgcolor="#FFFFFF"><a href="#" onclick="StudentTarget()">详细信息</a></td>')
                .append("</tr>")
          })
        }
      })
    ...
    let User = function() {
      this.init = function() {
        ...
        $("#uploadEventFile2").bind("change", function() {
          $("#uploadEventPath").attr("value", $("#uploadEventFile2").val());
        });
      };
      //点击上传按钮
      this.uploadBtn = function() {
        let uploadEventFile2 = $("#uploadEventFile2").val();
        if(uploadEventFile2 == '') {
          alert("请选择Excel文件, 再上传");
        }else if(uploadEventFile2.lastIndexOf(".xls") < 0) {
          alert("只能上传Excel文件");
        }else {
...
<div id="function">
  ...
  <div id="studentDetail" class="detailDivs">
    <form>
      ...
      <span class="infoText">身份证号：</span><input type="number" name="sIDcardNo" placeholder="学生的身份证号码" readonly><br>
      <span class="infoText">入学年份：</span><input type="month" name="sEnrollYear" placeholder="学生的入学时间" readonly><br>
      <span class="infoText">手机号码：</span><input type="tel" name="sPhone" placeholder="学生的手机号码" readonly><br>
      <span class="infoText">邮箱地址：</span><input type="email" name="sEmail" placeholder="学生的邮箱" readonly><br>
